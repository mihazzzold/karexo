...
![Интерфейс после входа: боковая панель слева, страница в центре, правая панель с оглавлением](screenshots/editor.png)

### 📱 На телефоне и планшете

Тот же интерфейс, только раскладка меняется: боковая панель уезжает в выдвижной ящик по кнопке
слева вверху, меню `/` и панель форматирования выезжают снизу - под большой палец, а колонки
таблицы разворачиваются в карточки «свойство - значение».

Правая панель на телефоне не занимает ширину: её открывает кнопка **«Панель страницы»** в шапке,
справа от поиска. Панель ложится поверх страницы и закрывается сама, как только вы перешли по
заголовку из оглавления или по бэклинку; ещё её закрывают тап мимо и `Esc`.

| Телефон | Ящик с деревом страниц | Панель страницы | Планшет |
|---|---|---|---|
| ![Страница на телефоне](screenshots/mobile.png) | ![Дерево страниц выдвижным ящиком](screenshots/mobile-nav.png) | ![Оглавление поверх страницы](screenshots/mobile-dock.png) | ![Страница на планшете](screenshots/tablet.png) |
