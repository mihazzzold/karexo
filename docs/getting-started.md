...
| Телефон | Ящик с деревом страниц | Планшет |
|---|---|---|
| ![Страница на телефоне](screenshots/mobile.png) | ![Дерево страниц выдвижным ящиком](screenshots/mobile-nav.png) | ![Страница на планшете](screenshots/tablet.png) |
